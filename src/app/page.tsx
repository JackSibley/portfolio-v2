          ...
          <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
            <div>
              ...
              <p className="mt-4 max-w-xs leading-normal">
                Crafting digital dreams with code. From classroom to compiler, I
                turn concepts into elegant software solutions.{" "}
              </p>
              {Nav()}
            </div>
            <ul
                    ...
                    <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:col-span-6">
                        ...
                        <p className="mt-2 text-sm leading-normal">
                          ...
                          audience interaction, client communication, equipment
                          maintenance, schedule management, budget control, and
                          networking.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:col-span-6">
                        ...
                        <p className="mt-2 text-sm leading-normal">
                          ...
                          handled business admin tasks such as payroll and stock
                          ordering, and assisted in policy development to
                    ...
                    <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:col-span-6">
                        ...
                        <p className="mt-2 text-sm leading-normal">
                          ...
                          while successfully meeting urgent demands and ensuring
                          strict compliance and top-notch quality.
                        </p>
                      </div>
                    </div>
                  </li>
